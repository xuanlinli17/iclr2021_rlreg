...
class Runner(AbstractEnvRunner):
    ...
    - Make a mini batch
    """
    def __init__(self, *, env, model, nsteps, gamma, lam, todropoutpi, dropoutpi_keep_prob, todropoutvf, dropoutvf_keep_prob, isbnpitrainmode, isbnvftrainmode):
    ...
    def run(self):
        ...
        if self.todropoutpi or self.todropoutvf:
        ...
        for _ in range(self.nsteps):
            ...
            actions, values, self.states, neglogpacs = self.model.step(self.obs, **stepdict)
        ...
        #last_values = self.model.value(self.obs, S=self.states, M=self.dones, dropoutvf_keep_prob=1.0)
        last_values = self.model.value(self.obs, **stepdict)
