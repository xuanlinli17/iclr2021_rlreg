...
def build_policy(env, policy_network, value_network=None,  normalize_observations=False, estimate_q=False, **policy_kwargs):
    ...
    if todropoutpi or todropoutvf:
        print("Dropout: policy = {}, value = {}".format(policy_kwargs['dropoutpi'], policy_kwargs['dropoutvf']))
        policy_network, dropoutpi_keep_prob, dropoutvf_keep_prob = get_network_builder(network_type)(**policy_kwargs)
    else:
