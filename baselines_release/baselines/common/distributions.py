...
class DiagGaussianPdType(PdType):
    ...
    def pdfromlatent_logstdfromnetwork(self, latent_vector, init_scale=1.0, init_bias=0.0):
        mean_and_logstd = _matching_fc(latent_vector, 'pi', self.size * 2, init_scale=init_scale, init_bias=init_bias)
        mean = mean_and_logstd[..., :self.size]
        return self.pdfromflat(mean_and_logstd), mean
